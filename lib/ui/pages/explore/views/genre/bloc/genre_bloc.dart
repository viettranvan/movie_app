...
class GenreBloc extends Bloc<GenreEvent, GenreState> {
  ...
  FutureOr<void> _onFetchData(FetchData event, Emitter<GenreState> emit) async {
    try {
      final movieResult = await exploreRepository.getGenreMovie(language: event.language);
      final tvResult = await exploreRepository.getGenreTv(language: event.language);
